...
const minivanEkspresTasimacilik: SeoPageData = {
  ...
  priceTable: {
    ...
    disclaimer:
      "Fiyatlar komple panelvan (yaklaşık 1.300 kg / 5 palet / 13-14 m³ sınıfı) taşıma için tahmini aralıklardır; sezon, yakıt ve talebe göre değişir. Koli ve parsiyel gönderiler hacme göre fiyatlandırılır — kesin fiyat için uygulamadan anında teklif alın.",
  },
  sections: [
    {
      heading: "Araç Kapasitesi: Ekspres Panelvana Ne Sığar?",
      paragraphs: [
        "Ekspres taşımada kullandığımız panelvan sınıfı araçlar, yaklaşık 1.300 kg yük, 5 Euro palet ve 13-14 m³ hacim kapasitesindedir. Bu kapasite, kritik bir üretim partisini, komple bir fuar standını, sezonluk bir tekstil koleksiyonunu veya hacimli bir yedek parça sevkiyatını tek araçta taşımaya yeter. Aracın tamamı sizin yükünüze ayrılır; başka gönderici beklenmez, ara depoya girilmez, rota yalnızca sizin teslimat adresinize göre çizilir.",
    ...
    {
      heading: "Panelvana Kaç Palet Sığar?",
      paragraphs: [
        "Sprinter sınıfı ekspres panelvanlarımızın yükleme alanı yaklaşık 4,2 metre uzunluğundadır; bu boy, standart Euro palet (80 × 120 cm) ölçüsünde 5 palete karşılık gelir. Toplam hacim 13-14 m³, azami yük ağırlığı ise yaklaşık 1.300 kg'dır. Yani bir express van, kamyonet algısının çok ötesinde, küçük bir ticari sevkiyatın tamamını tek seferde taşıyabilen bir kapasite sunar. Bu kapasiteye sığan tipik yükler şunlardır:",
      ],
      list: [
        "5 Euro palete istiflenmiş ticari ürün, numune veya yedek parça sevkiyatı",
        "60-80 adet standart koliden oluşan e-ticaret veya toptan ürün yükü",
        "Komple bir fuar standı: panolar, banko, aydınlatma ve tanıtım malzemeleri",
        "Kalıp, servo motor, kontrol panosu gibi tekil ağır endüstriyel parçalar",
        "Koltuk takımı, beyaz eşya ve kolilerden oluşan küçük ölçekli bir ev taşıması",
      ],
    },
    {
      heading: "Neden TIR Değil, Ekspres Minivan?",
      paragraphs: [
        "Sektörde minivan express, express van veya minibüs taşımacılık adlarıyla da anılan bu hizmeti Avrupa hattında TIR'a karşı avantajlı kılan şey yalnızca aracın küçük olması değil, tabi olduğu kuralların farklı olmasıdır. Zaman kritik yüklerde farkı yaratan dört unsur şunlardır:",
      ],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        "Ekspres minivan taşımanız dört adımda tamamlanır; her adımı uygulamadan takip edersiniz, telefon trafiğine veya e-posta beklemeye gerek kalmaz:",
      ],
      list: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Ekspres taşımada kullandığımız panelvan sınıfı yaklaşık 1.300 kg, 5 Euro palet ve 13-14 m³ kapasitelidir. Bu hacim komple bir fuar standı, palet bazlı ticari yük veya hacimli yedek parça sevkiyatı için yeterlidir.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sprinter sınıfı bir panelvanın tamamının tek göndericiye tahsis edilerek yükün aktarmasız, kapıdan kapıya ve 24-72 saat içinde taşınmasıdır. Minibüs taşımacılık veya express van olarak da bilinen bu model, depo beklemesi ve elleçleme içermediği için hem klasik kargodan hem de parsiyel TIR'dan çok daha hızlıdır.",
    },
    {
      question: "Express van ile TIR arasındaki fark nedir?",
      answer:
        "TIR 33 palete kadar yük alır ama hafta sonu seyir yasağına tabidir, sınırda ağır vasıta kuyruğuna girer ve parsiyel organizasyonlarda teslimat 7-15 günü bulur. Express van yaklaşık 5 palet / 1.300 kg kapasitelidir; hafta sonu yasağından muaf, çift şoförlü ve aktarmasız çalıştığı için aynı güzergâhı 24-72 saatte tamamlar. Yükünüz 5 paleti aşmıyorsa ve süre kritikse doğru araç express vandır.",
    },
    {
      question: "Acil yükümü aynı gün alabilir misiniz?",
      answer:
        "Evet. Araç müsaitliğine göre yükünüz aynı gün adresinizden alınıp yola çıkarılabilir; acil durumlarda en hızlı çözüm için uygulamadan talebinizi oluşturmanız yeterlidir. Üretim hattını durduran parçalar gibi saat hassasiyetindeki sevkiyatlar için acil yedek parça sevkiyatı hizmetimize göz atabilirsiniz.",
    },
    {
      question: "Minivan nakliye fiyatları ne kadar?",
      answer:
        "Komple araçta fiyat güzergâha göre değişir: örneğin İstanbul-Amsterdam hattında " +
        priceRange("Amsterdam") +
        ", İstanbul-Milano hattında " +
        priceRange("Milano") +
        ", İstanbul-Varşova hattında " +
        priceRange("Varşova") +
        " aralığındadır. Parsiyel gönderiler hacme göre daha düşük fiyatlandırılır; kesin rakam için uygulamadan kalkış-varış noktanızı seçip anında teklif alabilirsiniz.",
    },
  ],
  related: [
