  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Tek başına bir palet ya da birkaç koli gönderiyorsanız parsiyel taşımacılık seçeneğiyle yalnızca kullandığınız hacim kadar ödeme yaparsınız. Almanya'daki depolara mal gönderen e-ticaret satıcıları için ise Amazon FBA lojistik hattımız, teslim randevusu ve etiketleme gereklerine uygun şekilde planlanır. Gönderi boyunca takip numaranızla sevkiyatınızın hangi aşamada olduğunu (talep alındı, anlaşma, yolda, teslim edildi) görür, aracın o anki yerini WhatsApp'tan sorabilirsiniz. Taşıma, CMR konvansiyonunun belirlediği taşıyıcı sorumluluğu altında yürür; bu sorumluluk brüt kilogram başına 8,33 SDR ile sınırlı olduğu için, talep üzerine beyan ettiğiniz değer üzerinden ek yük sigortası yaptırıyoruz.",
