...
const TITLE = "Uluslararası Nakliyat Fiyat Hesaplama | m³ ve Palet | RouteEU";
const DESCRIPTION =
...
const FAQ: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Tahmini aralıklar kapıdan kapıya taşıma ve taşıma sigortası bedelini kapsar. Gümrük vergisi, ithalat KDV'si ve gümrük müşavirliği ücretleri gönderinin niteliğine (ticari mal, zati eşya, numune) göre değiştiği için ayrı değerlendirilir; teklif aşamasında hangi kalemlerin dahil olduğunu net olarak yazılı paylaşıyoruz.",
  },
  {
      ...
      <main className="mx-auto max-w-3xl px-5 pb-16">
        ...
        <article>
          <h1 className="mt-4 text-2xl font-black leading-tight sm:text-3xl">
            Uluslararası Nakliyat Fiyat Hesaplama
          </h1>
          <p className="mt-4 leading-relaxed text-muted-foreground">
            Türkiye'den Avrupa'ya göndereceğiniz yükün tahmini maliyetini saniyeler içinde görün.
            Varış şehrini seçin, yükünüzün hacmini metreküp veya palet olarak girin; hesaplayıcı
            komple panelvan ve parsiyel taşıma için güncel fiyat aralığını gösterir. Ölçüleri
            bilmiyorsanız aşağıdaki hacim hesaplayıcı en, boy ve yükseklikten m³ değerini sizin için
            bulur.
          </p>
