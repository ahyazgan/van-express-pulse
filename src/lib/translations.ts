...
export const translations = {
  tr: {
    ...
    orderForm: {
      ...
      submitFallback: "Bağlantı sorunu oldu. Talebinizi WhatsApp'tan gönderin; bilgiler hazır.",
      submitFallbackAction: "WhatsApp'tan gönder",
  ...
  en: {
    ...
    orderForm: {
      ...
      submitFallback: "Connection problem. Send your request on WhatsApp; the details are ready.",
      submitFallbackAction: "Send on WhatsApp",
